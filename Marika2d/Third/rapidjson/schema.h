...
public:
    ...
    bool Null() { return WriteType(NullType); }
    bool Bool(bool b) { return WriteType(b ? TrueType : FalseType); }
    ...
    bool RawNumber(const Ch* str, SizeType len, bool) {
        WriteBuffer(NumberType, str, len * sizeof(Ch));
        return true;
    }

    bool String(const Ch* str, SizeType len, bool) {
        WriteBuffer(StringType, str, len * sizeof(Ch));
        return true;
    }
...
private:
    ...
    bool WriteNumber(const Number& n) { return WriteBuffer(NumberType, &n, sizeof(n)); }
...
public:
        ...
        nullable_(false)
    {
        ...
        const ValueType* dependencies = GetMember(value, GetDependenciesString());
        {
            ...
            SValue allProperties(ArrayType);
...
public:
    ...
    */
        ...
        currentError_()
    {
        ...
        new (typeless_) SchemaType(this, PointerType(), ValueType(ObjectType).Move(), ValueType(ObjectType).Move(), allocator_, docId_);
    ...
    void SchemaError(const SchemaErrorCode code, const PointerType& location) {
      currentError_ = GValue(ObjectType);
...
public:
    ...
    */
    ...
    void DuplicateItems(SizeType index1, SizeType index2) {
        ValueType duplicates(ArrayType);
        ...
        *documentStack_.template Push<Ch>() = '\0';
        ...
        if (!schemaStack_.Empty()) {
            ...
            if (hasher && context.valueUniqueness) {
                ...
                if (!a)
                    CurrentContext().arrayElementHashCodes = a = new (GetStateAllocator().Malloc(sizeof(HashCodeArray))) HashCodeArray(ArrayType);
...
public:
    ...
    */
    SchemaValidatingReader(InputStream& is, const SchemaDocumentType& sd) : is_(is), sd_(sd), invalidSchemaKeyword_(), invalidSchemaCode_(kValidateErrorNone), error_(ObjectType), isValid_(true) {}
