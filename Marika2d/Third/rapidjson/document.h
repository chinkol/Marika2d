...
public:
    ...
    */
    explicit GenericValue(Type type) RAPIDJSON_NOEXCEPT : data_() {
        ...
        RAPIDJSON_NOEXCEPT_ASSERT(type >= NullType && type <= NumberType);
    ...
    */
    ...
    bool operator==(const GenericValue<Encoding, SourceAllocator>& rhs) const {
        ...
        switch (GetType()) {
        case ObjectType: // Warning: O(n^2) inner-loop
    ...
    */
    ...
    /*! \post IsObject() == true */
    GenericValue& SetObject() { this->~GenericValue(); new (this) GenericValue(ObjectType); return *this; }
    ...
    */
    ...
    /*! \post IsArray == true */
    GenericValue& SetArray() { this->~GenericValue(); new (this) GenericValue(ArrayType); return *this; }
    ...
    */
    ...
    bool Accept(Handler& handler) const {
        switch(GetType()) {
        case NullType:     return handler.Null();
        case FalseType:    return handler.Bool(false);
        case TrueType:     return handler.Bool(true);
        ...
        default:
            RAPIDJSON_ASSERT(GetType() == NumberType);
...
private:
    ...
    enum {
        ...
        kTrueFlag = static_cast<int>(TrueType) | static_cast<int>(kBoolFlag),
        kFalseFlag = static_cast<int>(FalseType) | static_cast<int>(kBoolFlag),
        kNumberIntFlag = static_cast<int>(NumberType) | static_cast<int>(kNumberFlag | kIntFlag | kInt64Flag),
        kNumberUintFlag = static_cast<int>(NumberType) | static_cast<int>(kNumberFlag | kUintFlag | kUint64Flag | kInt64Flag),
        kNumberInt64Flag = static_cast<int>(NumberType) | static_cast<int>(kNumberFlag | kInt64Flag),
        kNumberUint64Flag = static_cast<int>(NumberType) | static_cast<int>(kNumberFlag | kUint64Flag),
        kNumberDoubleFlag = static_cast<int>(NumberType) | static_cast<int>(kNumberFlag | kDoubleFlag),
        kNumberAnyFlag = static_cast<int>(NumberType) | static_cast<int>(kNumberFlag | kIntFlag | kInt64Flag | kUintFlag | kUint64Flag | kDoubleFlag),
        kConstStringFlag = static_cast<int>(StringType) | static_cast<int>(kStringFlag),
        kCopyStringFlag = static_cast<int>(StringType) | static_cast<int>(kStringFlag | kCopyFlag),
        kShortStringFlag = static_cast<int>(StringType) | static_cast<int>(kStringFlag | kCopyFlag | kInlineStrFlag),
        kObjectFlag = ObjectType,
        kArrayFlag = ArrayType,
    ...
    void DoCopyMembers(const GenericValue<Encoding,SourceAllocator>& rhs, Allocator& allocator, bool copyConstStrings) {
        RAPIDJSON_ASSERT(rhs.GetType() == ObjectType);
...
public:
    ...
    bool StartObject() { new (stack_.template Push<ValueType>()) ValueType(ObjectType); return true; }
    ...
    bool StartArray() { new (stack_.template Push<ValueType>()) ValueType(ArrayType); return true; }
